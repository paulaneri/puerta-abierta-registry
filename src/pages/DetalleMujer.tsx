      ...
      <main className="w-full px-4 sm:px-6 py-6 sm:py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-3 mb-6 h-auto">
            <TabsTrigger value="datos" className="text-xs sm:text-sm font-medium px-1 py-2 whitespace-normal leading-tight">Datos Personales</TabsTrigger>
            <TabsTrigger value="acompanamiento" className="text-xs sm:text-sm font-medium px-1 py-2 whitespace-normal leading-tight">Acompañamientos</TabsTrigger>
            <TabsTrigger value="trabajo-campo" className="text-xs sm:text-sm font-medium px-1 py-2 whitespace-normal leading-tight">Trabajo de Campo</TabsTrigger>
          </TabsList>
